...
from networkSecurity.entity.artifact_entity import DataTrasformationArtifact, DataValidationArtifact
from networkSecurity.entity.config_entity import DataTransformationConfig
import numpy as np
import pandas as pd
from sklearn.impute import KNNImputer
from sklearn.pipeline import Pipeline
from networkSecurity.utils.main_utils.utils import save_numpy_array_data, save_object, read_yaml
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initialises a knn imputer object with the parametetrs specified in the training_pipeline.py file and returns a pipleine
        ...
        try:
            ...
            logging.info(f"Initialized knn imputerr with {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
